...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('lancerApp', '0026_auto_20160301_1538'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='type',
            field=models.CharField(unique=True, max_length=20, verbose_name='\u0432\u0438\u0434', choices=[(b'lancer9', b'Lancer 9'), (b'lancer10', b'Lancer X'), (b'evo', b'Evolution'), (b'asx', b'Lancer ASX')]),
        ),
        migrations.AlterField(
            model_name='service',
            name='type',
